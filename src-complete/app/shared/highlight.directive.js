...
var HighlightDirective = (function () {
    function HighlightDirective(el, renderer) {
        ...
        //@Input("highlight")
        this.color = "green";
        this.highlightEvent = new core_1.EventEmitter();
        this.renderer.setElementStyle(this.el.nativeElement, 'backgroundColor', 'yellow');
    }
    HighlightDirective.prototype.mouseEnter = function (event) {
    ...
    HighlightDirective.prototype.mouseLeave = function (event) {
        this.renderer.setElementStyle(this.el.nativeElement, 'backgroundColor', 'yellow');
    ...
    __decorate([
        core_1.Output("highlight"), 
        __metadata('design:type', core_1.EventEmitter)
    ], HighlightDirective.prototype, "highlightEvent", void 0);
